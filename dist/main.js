...
class Response {
    ...
    headers = new Map();
    body = "";
    formatStatusLine = () => `HTTP/1.1 ${this.statusCode} ${STATUS_TEXT[this.statusCode]}`;
    ...
    ToString = () => {
        console.log(`${this.formatStatusLine()}${this.appendDelimiter()}${this.appendHeaders()}${this.appendDelimiter()}${this.appendDelimiter()}${this.appendBody()}`);
    };
}
const STATES = {
    1: "StatusCode",
